...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#081229] text-slate-400 border-t border-slate-800/80 pt-16 pb-12 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="space-y-2.5 text-xs font-mono text-slate-300">
              ...
              <div className="flex items-center gap-2 text-slate-400 italic">
                ...
                <span>WhatsApp: use the floating green icon ↘</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono">
          ...
          <button
            onClick={scrollToTop}
            className="p-2 px-4 rounded-lg bg-[#1C2B5E] text-[#B8962E] hover:bg-[#B8962E] hover:text-white transition-colors flex items-center gap-1.5 cursor-pointer border border-[#B8962E]/30"
